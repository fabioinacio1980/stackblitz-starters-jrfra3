...
// letiável é um nome simbólico para um valor.
// As letiáveis são declaradas com a palavra-chave let ou const:

let x; // Declara uma letiável chamada x.

// Valores podem ser atribuídos às letiáveis com o sinal =

x = 0; // Agora a letiável x tem o valor 0
x // => 0: Uma letiável é avaliada com seu valor.
...
let book = { // Objetos são colocados entre chaves.
...
// as variáveis declaradas como let podem ser alteradas na sua totalidade
// as variáveis declaradas como const, não podem ser alteradas na sua totalidade, porem podem ser alterados atributos específicos dentro dela.
...
//Em linhas gerais, uma expressão é algo que calcula um valor, mas não faz nada: ela não altera o estado do programa de modo algum.

//As instruções, por outro lado, não têm um valor (ou não têm um valor com que nos preocupemos), mas alteram o estado

//A outra categoria abrangente de instrução são as estruturas de controle, como as condicionais e os laços.
